...
public class MathTest {
	...
	public void testSum() {
		...
		assertEquals(sum.evaluate(), 3.0, 0.02);
	}
	...
	public void testProduct() {
		...
		assertEquals(product.evaluate(), 21.0, 0.02);
	}
	...
	public void testDifference() {
		...
		assertEquals(difference.evaluate(), 8.0, 0.02);
	}
	...
	public void testSin() {
		...
		assertEquals(sin.evaluate(), 0.5, 0.02);
	}
	...
	public void testCos() {
		...
		assertEquals(cos.evaluate(), 0.5, 0.02);
	}
	...
	public void testTan() {
		...
		assertEquals(tan.evaluate(), 1.19, 0.02);
	}
...
//	}
	...
	public void testLog() {
		...
		assertEquals(log.evaluate(), 1.61, 0.02);
	}
