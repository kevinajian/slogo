...
public class BooleanTest {
	...
	public void testAnd() {
		...
		assertEquals(and.evaluate(), 1.0, 0.0);
	}
	...
	public void testNotAnd() {
		...
		assertEquals(and.evaluate(), 0.0, 0.0);
	}
	...
	public void testOr() {
		...
		assertEquals(or.evaluate(), 1.0, 0.0);
	}
	...
	public void testNotOr() {
		...
		assertEquals(or.evaluate(), 0.0, 0.0);
	}
	...
	public void testGreaterThan() {
		...
		assertEquals(greater.evaluate(), 1.0, 0.0);
	}
	...
	public void testLessThan() {
		...
		assertEquals(less.evaluate(), 1.0, 0.0);
	}
	...
	public void testEqualTo() {
		...
		assertEquals(equal.evaluate(), 1.0, 0.0);
	}
	...
	public void testNotEqualTo() {
		...
		assertEquals(equal.evaluate(), 0.0, 0.0);
	}
