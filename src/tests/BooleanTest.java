...
public class BooleanTest {
	...
	public void testAnd() {
		...
		assertEquals(and.evaluate(model), 1.0, 0.0);
	}
	...
	public void testNotAnd() {
		...
		assertEquals(and.evaluate(model), 0.0, 0.0);
	}
	...
	public void testOr() {
		...
		assertEquals(or.evaluate(model), 1.0, 0.0);
	}
	...
	public void testNotOr() {
		...
		assertEquals(or.evaluate(model), 0.0, 0.0);
	}
	...
	public void testGreaterThan() {
		...
		assertEquals(greater.evaluate(model), 1.0, 0.0);
	}
	...
	public void testLessThan() {
		...
		assertEquals(less.evaluate(model), 1.0, 0.0);
	}
	...
	public void testEqualTo() {
		...
		assertEquals(equal.evaluate(model), 1.0, 0.0);
	}
	...
	public void testNotEqualTo() {
		...
		assertEquals(equal.evaluate(model), 0.0, 0.0);
	}
