...
public class Constants {
	...
	public static final List<String> SUM_OP = new String[]{"SUM")}}; 
	public static final List<String> DIFFERENCE_OP = new String[]{"DIFFERENCE")}};
	public static final List<String> PRODUCT = new String[]{"PRODUCT")}};
	public static final List<String> QUOTIENT = new String[]{"QUOTIENT")}};
	public static final List<String> REMAINDER = new String[]{"REMAINDER")}};
	public static final List<String> MINUS = new String[]{"MINUS")}};
